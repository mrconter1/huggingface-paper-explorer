        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center space-x-4 mb-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded inline-flex items-center transition-colors duration-300"
            >
          ...
          <p className="text-sm text-gray-500">All paper data and content belong to their respective owners and the HuggingFace community.</p>
        </div>
